...
| `cpp/eudamed_migel.cpp` | C++ | Match EUDAMED devices against Swiss MiGeL codes (uses migel.hpp) |
| `cpp/migel.hpp` | C++ | Header-only MiGeL CSV parser & keyword matcher (no external deps) |
